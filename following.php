...
if (isset($_GET['username'])) {
    ...
    $dbfollowers = DB::query('SELECT list5.username, list5.profile_pic FROM list5, followers
                             WHERE list5.id = followers.user_id
                             AND follower_id = :userid', array(':userid'=>$userid)); // $userid = die "id" der Person, auf deren Profilseite wir sind
...
<form action="following.php?username=<?php echo $username; ?>" method="post">
