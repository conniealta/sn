    ...
    foreach ($notifications as $n) {
        if ($n['type'] == 1) {
            ...
            if ($n['extra'] == "") {
                ...
                echo "<a href='profile.php?username=" . $senderName . "'> @$senderName </a> hat dich in einem  <a href='profile.php?username=$senderName&postid=".$n['post_id']." '>Post</a> markiert! - " . $extra->postbody . "<hr />";
            }
